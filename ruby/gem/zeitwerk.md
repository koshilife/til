...
$ echo "module ZeitwerkSandboxGem; module Foo1; class Hoge1; def self.hello; puts name; end; end; end; end" > foo1/bar/hoge1.rb
$ echo "module ZeitwerkSandboxGem; module Foo2; class Hoge2; def self.hello; puts name; end; end; end; end" > foo2/bar/hoge2.rb
```
